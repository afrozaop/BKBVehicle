<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FuelReport.aspx.cs" Inherits="BKBVehicle.Report.FuelReport" %>
...
<body>
    ...
    <div>
     <asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        <rsweb:reportviewer id="Fuelrpt" runat="server" style="" width="100%" height="100%" zoommode="PageWidth" showprintbutton="true"
