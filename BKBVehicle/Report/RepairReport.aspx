<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RepairReport.aspx.cs" Inherits="BKBVehicle.Report.RepairReport" %>
...
<body>
    ...
    <div>
     <asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        <rsweb:reportviewer id="Repairrpt" runat="server" style="" width="100%" height="100%" zoommode="PageWidth" showprintbutton="true"
