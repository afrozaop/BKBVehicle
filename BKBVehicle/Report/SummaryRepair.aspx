<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SummaryRepair.aspx.cs" Inherits="BKBVehicle.Report.SummaryRepair" %>
...
<body>
    ...
    <div>
     <asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        <rsweb:reportviewer id="SummaryRepairrpt" runat="server" style="" width="100%" height="100%" zoommode="PageWidth" showprintbutton="true"
